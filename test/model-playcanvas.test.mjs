...
test('inline3d-playcanvas-engine.js exports every engine member the two adapters read', () => {
  ...
  const used = new Set();
  for (const f of ['inline3d-splat-playcanvas.js', 'inline3d-model-playcanvas.js']) {
...
test('the default model path imports neither three nor playcanvas statically (both are dynamic)', () => {
  for (const f of ['inline3d-model-entry.js', 'inline3d-model-playcanvas.js', 'inline3d-splat-playcanvas.js', 'inline3d-splat-shared.js', 'inline3d-splat-rig.js', 'inline3d-sog.js', 'inline3d-splat-perf.js', 'inline3d-viewer.js', 'inline3d-three.js']) {
